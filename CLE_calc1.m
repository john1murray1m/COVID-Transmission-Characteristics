function [G1,G2,KickOut,flag_opt]=CLE_calc1(G20,KickOut,ncount)
...
%     highlight(p,'Edges',edgecycles{1},'EdgeColor','r','LineWidth',1.5,'NodeColor','r','MarkerSize',6)
    ...
    % has a cycle so contract the nodes into one
    % Nodes1=table(ncount,'VariableNames',{'Nodes'});
